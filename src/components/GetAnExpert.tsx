...
const GetAnExpert = () => {
  ...
  const stats = [
    {
      ...
      number: "20",
      label: t("getExpert.stats.years"),
    },
    {
      icon: <Users className="h-8 w-8" />,
      number: "2400",
      label: t("getExpert.stats.works"),
    },
    {
      icon: <Scale className="h-8 w-8" />,
      number: "500",
      label: t("getExpert.stats.customers"),
    },
    {
      icon: <Globe className="h-8 w-8" />,
      number: "15",
      label: t("getExpert.stats.team"),
    },
  ];
  ...
  return (
    ...
    >
      {" "}
      {/* even further reduced bottom padding for compactness */}
      {/* Background Pattern */}
      <div
      ...
      <div className="relative z-10 pt-8">
        {" "}
        {/* lower z-index so image can overlap */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div
                  className="text-sm uppercase tracking-wide text-gray-600 font-medium"
                  style={{
                    fontFamily: "'Playfair Display', serif", // or "'Cormorant Garamond', serif"
                    color: "#f5c15c ",
                  }}
      ...
      <div className="container mx-auto px-4 relative z-30 mt-[-120px]">
        {" "}
        {/* more negative margin for more overlap, higher z-index */}
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="text-white relative z-50"  // ⬅️ ensure above image
            >
            ...
            <p
              className="text-lg text-cream mb-8 leading-relaxed"
              style={{
                fontFamily: "'Playfair Display', serif", // or "'Cormorant Garamond', serif"
                color: "#CCCCCC",
              }}
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/contact"
                className="group inline-flex items-center font-serif transition-colors text-lg border-2 border-gold bg-transparent px-4 py-2 rounded-md  hover:text-white"
                style={{
