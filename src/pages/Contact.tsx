  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        className: "bg-[#030915] text-[#F5F5F5]",
        style: {
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-center mt-6">
                  <Button
                    ...
                    className=" border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald focus:border-transparent bg-transparent text-gold font-semibold px-6 py-3 rounded-lg transition-all duration-300 hover:shadow-lg"
                  >
                    {isSubmitting ? (
