  ...
  const services = [
    {
      ...
      image: "https://i0.wp.com/verdict.justia.com/wp-content/uploads/2013/04/gavel.jpg?resize=1200%2C440&quality=100&strip=all&fit=1000%25",
      color: "emerald",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      image: "/lovable-uploads/serv2.jpg",
      color: "darkBrown",
    },
    {
      id: 4,
      ...
      image: "/lovable-uploads/serv1.jpg",
      color: "emerald",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      icon: <Scale className="h-12 w-12" />,
      image: "/lovable-uploads/serv3.jpg",
      color: "emerald",
    },
  ];

  const handleServiceClick = (service) => {
    // don't scroll the whole page — just open modal
    setSelectedService(service);
    // ensure modal content starts at top when it appears
    // small timeout lets the modal mount first
    // setTimeout(() => modalContentRef.current?.scrollTo?.({ top: 0 }), 0);
  };
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <div className="flex items-center space-x-2 mb-18">
                ...
                <span className="text-white">{t("services.heading")}</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      {/* Service Detail Modal */}
        ...
        {selectedService && createPortal (
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={closeModal}
            className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-start justify-center pt-24"
            >
            <motion.div
              ...
              <div className="relative">
                ...
                <div className="relative h-64 overflow-hidden rounded-t-3xl">
                  ...
                  <div className="absolute bottom-6 left-8 text-white">
                    ...
                    <div className="bg-black/50 p-3 rounded-md w-fit">
                      <h2
                ...
                <div className="p-8">
                  <p
                    className="text-white text-xl underline mb-4"
                    style={{
                      fontFamily: "'Playfair Display', serif",
                      color: "#f5c15c",
                  ...
                  <p
                    className="text-lg text-darkBrown leading-relaxed mb-8"
                    style={{
                      fontFamily: "'Playfair Display', serif", // or "'Cormorant Garamond', serif"
                      color: "#F5F5F5",
                    }}
                  ...
                  <h3
                    className="text-2xl font-serif font-bold text-emerald mb-6"
                    style={{
                      fontFamily: "'Playfair Display', serif", // or "'Cormorant Garamond', serif"
                      color: "#F5F5F5",
                    }}
