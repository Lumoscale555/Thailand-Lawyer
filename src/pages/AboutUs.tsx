          ...
          <div className="grid lg:grid-cols-2  items-center">
            ...
            >
              <img
                ...
                className="w-92 h-[35rem] object-cover rounded-2xl shadow-2xl"
              />
            </motion.div>
            ...
            >
              <div
                className="mt-8 md:mt-0 border-l-4 border-gold pl-8"
                style={{
                  color: "#BFA75C",
              ...
              >
                ...
                <p>{t("aboutus.story4")}</p>
                <p>{t("aboutus.story5")}</p>
              </div>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              ...
              >
                ...
                {/* Content */}
                <h3
                  className="text-3xl font-serif font-bold text-white mb-4 group-hover:text-gold transition-colors duration-300"
                  style={{
                    fontFamily: "'Playfair Display', serif", // or "'Cormorant Garamond', serif"
                    color: "#BFA75C",
                  }}
                ...
                <p
                  className="text-white/80 text-1xl leading-relaxed group-hover:text-white transition-colors duration-300"
                  style={{
